...
.coming-soon-body { margin: 0; padding: 0; overflow-x: hidden; min-height: 100vh; }
.coming-soon-page {
    min-height: 100vh;
    display: flex;
    align-items: center;
...
.coming-soon-page .container { position: relative; z-index: 1; }
.coming-soon-logo {
    margin-bottom: 2rem;
}
.coming-soon-logo img { height: 56px; width: auto; }
...
.coming-soon-icon-wrap i { font-size: 2.5rem; color: #fff; }
@keyframes comingSoonIconPulse {
    0%, 100% { transform: scale(1); box-shadow: 0 12px 40px rgba(246, 175, 71, 0.25); }
    50% { transform: scale(1.05); box-shadow: 0 16px 48px rgba(246, 175, 71, 0.35); }
}
.coming-soon-page h1 {
...
.coming-soon-notify .form-control::placeholder { color: rgba(255,255,255,0.5); }
...
.coming-soon-decor i { font-size: 4rem; color: var(--brand-primary); }
.coming-soon-decor--building { top: 15%; left: 10%; }
.coming-soon-decor--key { bottom: 20%; right: 12%; }
.coming-soon-decor--home { top: 25%; right: 8%; }
.coming-soon-decor--chart { bottom: 25%; left: 10%; }
@media (max-width: 768px) {
    .coming-soon-decor { display: none; }
}
.coming-soon-lang {
    position: absolute;
    top: 1.5rem;
...
.coming-soon-lang a:hover { color: var(--brand-primary); background: rgba(255,255,255,0.08); }
</style>
@endpush
