...
@section('content')
    ...
    @php
        $hasContentStats = isset($contentStats) && (
            ($contentStats['services'] ?? 0) > 0 ||
            ($contentStats['projects'] ?? 0) > 0 ||
            ($contentStats['blogs'] ?? 0) > 0 ||
            ($contentStats['partners'] ?? 0) > 0 ||
            ($contentStats['testimonials'] ?? 0) > 0
        );
    @endphp
    @if($hasContentStats)
    <!-- محتوانا في أرقام -->
    <section class="content-stats-section py-5">
        <div class="container">
            <header class="section-header">
                <h2 class="section-header__title">{{ __('home.content_stats_title') }}</h2>
                <div class="section-header__line"></div>
            </header>
            <div class="row g-4 justify-content-center">
                @if(($contentStats['services'] ?? 0) > 0)
                <div class="col-6 col-md-4 col-lg">
                    <a href="{{ route('services') }}" class="content-stat-item text-decoration-none d-block h-100">
                        <div class="content-stat-icon"><i class="fas fa-concierge-bell"></i></div>
                        <div class="content-stat-number">{{ $contentStats['services'] }}</div>
                        <div class="content-stat-label">{{ __('home.content_services') }}</div>
                    </a>
                </div>
                @endif
                @if(($contentStats['projects'] ?? 0) > 0)
                <div class="col-6 col-md-4 col-lg">
                    <a href="{{ route('projects') }}" class="content-stat-item text-decoration-none d-block h-100">
                        <div class="content-stat-icon"><i class="fas fa-building"></i></div>
                        <div class="content-stat-number">{{ $contentStats['projects'] }}</div>
                        <div class="content-stat-label">{{ __('home.content_projects') }}</div>
                    </a>
                </div>
                @endif
                @if(($contentStats['blogs'] ?? 0) > 0)
                <div class="col-6 col-md-4 col-lg">
                    <a href="{{ route('blogs') }}" class="content-stat-item text-decoration-none d-block h-100">
                        <div class="content-stat-icon"><i class="fas fa-newspaper"></i></div>
                        <div class="content-stat-number">{{ $contentStats['blogs'] }}</div>
                        <div class="content-stat-label">{{ __('home.content_blogs') }}</div>
                    </a>
                </div>
                @endif
                @if(($contentStats['partners'] ?? 0) > 0)
                <div class="col-6 col-md-4 col-lg">
                    <a href="#partners" class="content-stat-item text-decoration-none d-block h-100">
                        <div class="content-stat-icon"><i class="fas fa-handshake"></i></div>
                        <div class="content-stat-number">{{ $contentStats['partners'] }}</div>
                        <div class="content-stat-label">{{ __('home.content_partners') }}</div>
                    </a>
                </div>
                @endif
                @if(($contentStats['testimonials'] ?? 0) > 0)
                <div class="col-6 col-md-4 col-lg">
                    <div class="content-stat-item content-stat-item--static">
                        <div class="content-stat-icon"><i class="fas fa-quote-right"></i></div>
                        <div class="content-stat-number">{{ $contentStats['testimonials'] }}</div>
                        <div class="content-stat-label">{{ __('home.content_testimonials') }}</div>
                    </div>
                </div>
                @endif
            </div>
